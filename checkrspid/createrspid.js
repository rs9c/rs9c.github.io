...
function creat(){
    ...
    x = (((Number(pid[22])+Number(pid[23])+Number(pid[24])+Number(pid[25]))%7+Number(pid[16])+Number(pid[17])+Number(pid[18])+Number(pid[19])+Number(pid[20])+Number(pid[21])+Number(pid[4])+Number(pid[5])+Number(pid[6])+Number(pid[7])+Number(pid[8])+Number(pid[9])+Number(pid[10])+Number(pid[11])+Number(pid[12])+Number(pid[13])+Number(pid[14])+Number(pid[15]))*Number(pid[26]+pid[27]+pid[20]+pid[1]+pid[17])+Number(pid[2])+Number(pid[3])+((Number(pid[0])+Number(pid[1]))*Number(pid[1])))%10;
