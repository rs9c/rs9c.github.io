...
function verify(){
    ...
    //显示生产日期和时间
    document.getElementById("sj").innerHTML=`<a>${"20"+String(Number(pid[20]+pid[21])-10)+"年"+String(Number(pid[18]+pid[19])-10)+"月"+String(Number(pid[16]+pid[17])-10)+"日"+String(Number(pid[22]+pid[23])-10)+":"+String(Number(pid[24]+pid[25])-10)}</a>`;
}
